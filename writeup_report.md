...
### Breif about Data Set and Explanation

#### 1. The coding is done using python due to good library/pacakage support such as numpy , pandas and metaplotlib .. 
  ...
  ```
#### 2.Explanation of visualization of the dataset.
